...
public class MainActivityTest {
    ...
    {
        onView(withId(R.id.button_add)).perform(click()); //Click add button to add a city to the list
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Satkhira")); //Type a city name
        Espresso.pressBack();
        ...
        onView(withId(R.id.button_add)).perform(click()); //Click add button to add a city to the list
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Bagerhat")); //Type a city name
        Espresso.pressBack();
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onView(withText("Bagerhat")).check(matches(isDisplayed()));
